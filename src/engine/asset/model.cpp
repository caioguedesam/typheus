...
Handle<Model> LoadModelOBJ(file::Path assetPath, bool flipVerticalTexcoord)
{
    ...
    u64 mtlDataSize = 0;
    u8* mtlData = file::ReadFileToBuffer(mtlPath, &mtlDataSize);
    ...
    // Parse mtl data
    HashMap<String, Handle<Material>> modelMaterials = obj::LoadMaterials(mtlData, mtlDataSize);
